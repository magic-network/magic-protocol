...
// File: contracts/token/MagicTokenFaucet.sol

/*
 * @title Faucet for the Magic Token
 */
contract MagicTokenFaucet is Ownable {

    // Token
    IMagicToken public token;
    ...
    /*
     * @dev MagicTokenFacuet constructor
     * @param _token Address of MagicToken
